...
- Вместо Scanner использовать потоки ввиду более высокой производительности при работе с большими файлами. По факту парсер здесь не нужен, только разделение построчно - вполне достаточно потока.
